...
const u8 gText_HealthboxGender_Male[] = _("{COLOR DYNAMIC_COLOR2}♂{COLOR LIGHT_BLUE}{LV}{COLOR BLUE}"); // Refer to charmap.txt to see which colors point to which index in a palette
const u8 gText_HealthboxGender_Female[] = _("{COLOR DYNAMIC_COLOR1}♀{COLOR LIGHT_BLUE}{LV}{COLOR BLUE}");
const u8 gText_HealthboxGender_None[] = _("{COLOR DYNAMIC_COLOR2}  {COLOR LIGHT_BLUE}{LV}{COLOR BLUE}");
