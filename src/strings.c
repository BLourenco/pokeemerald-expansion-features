...
const u8 gText_HealthboxGender_Male[] = _("{COLOR LIGHT_GRAY}♂{COLOR LIGHT_RED}{LV}{COLOR DARK_GRAY}"); // Refer to charmap.txt to see which colors point to which index in a palette
const u8 gText_HealthboxGender_Female[] = _("{COLOR RED}♀{COLOR LIGHT_RED}{LV}{COLOR DARK_GRAY}");
const u8 gText_HealthboxGender_None[] = _("{COLOR LIGHT_GRAY}  {COLOR LIGHT_RED}{LV}{COLOR DARK_GRAY}");
