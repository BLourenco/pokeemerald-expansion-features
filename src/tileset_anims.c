...
static const u16 sTilesetAnims_General_FRLG_Flower_Frame0[] = INCBIN_U16("data/tilesets/primary/general_FRLG/anim/flower/0.4bpp");
static const u16 sTilesetAnims_General_FRLG_Flower_Frame1[] = INCBIN_U16("data/tilesets/primary/general_FRLG/anim/flower/1.4bpp");
static const u16 sTilesetAnims_General_FRLG_Flower_Frame2[] = INCBIN_U16("data/tilesets/primary/general_FRLG/anim/flower/2.4bpp");
static const u16 sTilesetAnims_General_FRLG_Flower_Frame3[] = INCBIN_U16("data/tilesets/primary/general_FRLG/anim/flower/3.4bpp");
static const u16 sTilesetAnims_General_FRLG_Flower_Frame4[] = INCBIN_U16("data/tilesets/primary/general_FRLG/anim/flower/4.4bpp");

static const u16 *const sTilesetAnims_General_FRLG_Flower[] = {
    sTilesetAnims_General_FRLG_Flower_Frame0,
    sTilesetAnims_General_FRLG_Flower_Frame1,
    sTilesetAnims_General_FRLG_Flower_Frame2,
    sTilesetAnims_General_FRLG_Flower_Frame3,
    sTilesetAnims_General_FRLG_Flower_Frame4
};
...
{
    AppendTilesetAnimToBuffer(sTilesetAnims_General_FRLG_Flower[timer % ARRAY_COUNT(sTilesetAnims_General_FRLG_Flower)], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(508)), 4 * TILE_SIZE_4BPP);
}
