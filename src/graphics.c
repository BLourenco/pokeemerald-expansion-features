...
const u32 gHealthboxDoublesPartnerGfx[] = INCBIN_U32( "graphics/battle_interface/healthbox_doubles_partner.4bpp.lz");
...
const u32 gMoveTypeSymbols_Gfx[] = INCBIN_U32("graphics/types/move_types_symbols.4bpp.lz");
