...
const struct Tileset gTileset_Mart_FRLG =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Mart_FRLG,
    .palettes = gTilesetPalettes_Mart_FRLG,
    .metatiles = gMetatiles_Mart_FRLG,
    .metatileAttributes = gMetatileAttributes_Mart_FRLG,
    .callback = NULL,
    .isFRLGTileset = TRUE,
};
