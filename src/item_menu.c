...
static void BagMenu_Print(u8, u8, const u8 *, u8, u8, s8, s8, u8, u8);
...
static void BagMenu_Print(u8 windowId, u8 fontId, const u8 *str, u8 left, u8 top, s8 letterSpacing, s8 lineSpacing, u8 speed, u8 colorIndex)
{
